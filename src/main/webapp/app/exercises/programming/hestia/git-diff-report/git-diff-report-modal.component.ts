    ...
    private loadRepositoryFilesForParticipations() {
        if (this.report.participationIdForFirstCommit) {
            this.programmingExerciseParticipationService
                .getParticipationRepositoryFilesWithContentAtCommit(this.report.participationIdForFirstCommit!, this.report.templateRepositoryCommitHash)
                .subscribe({
        ...
        this.programmingExerciseParticipationService
            .getParticipationRepositoryFilesWithContentAtCommit(this.report.participationIdForSecondCommit!, this.report.solutionRepositoryCommitHash)
            .subscribe({
                next: (filesWithContent: Map<string, string>) => {
