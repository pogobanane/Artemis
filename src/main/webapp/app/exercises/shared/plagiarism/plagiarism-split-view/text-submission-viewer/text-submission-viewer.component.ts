...
export class TextSubmissionViewerComponent implements OnChanges {
    ...
    private loadProgrammingExercise(currentPlagiarismSubmission: PlagiarismSubmission<TextSubmissionElement>) {
        ...
        const domain: DomainChange = [DomainType.PARTICIPATION, { id: currentPlagiarismSubmission.submissionId, results: [], submissions: [] }];
    ...
    handleFileSelect(file: string) {
        ...
        const domain: DomainChange = [DomainType.PARTICIPATION, { id: this.plagiarismSubmission.submissionId, results: [], submissions: [] }];
