...
public class LocalGitService extends AbstractVersionControlService {
    ...
    private String serverBaseRoute = "http://localhost:8080/git";
    ...
    public LocalGitService(PasswordService passwordService, @Qualifier("localGitRestTemplate") RestTemplate restTemplate, UserRepository userRepository, UrlService urlService,
    ...
    public VcsRepositoryUrl getCloneRepositoryUrl(String projectKey, String repositorySlug) {
        final var cloneUrl = new LocalGitRepositoryUrl(projectKey, repositorySlug);
        return cloneUrl;
    }
    ...
    private LocalGitProjectDTO getLocalGitProject(String projectKey) throws LocalGitException {
        ...
        /*
         * return return restTemplate.exchange(localGitServerUrl + "/project/" + projectKey, HttpMethod.GET, null, LocalGitProjectDTO.class).getBody();
         */
    }
    ...
    public void createProjectForExercise(ProgrammingExercise programmingExercise) throws LocalGitException {
        ...
        /*
         * final var body = new BitbucketProjectDTO(projectKey, projectName); HttpEntity<?> entity = new HttpEntity<>(body, null);
         */
        ...
        /*
         * } catch (HttpClientErrorException e) { log.error("Could not create local git project {} with key {}", projectName, projectKey, e); throw new
    ...
    private void createRepository(String projectKey, String repoName) throws LocalGitException {
        ...
        /*
         * try { restTemplate.exchange(bitbucketServerUrl + "/rest/api/latest/projects/" + projectKey + "/repos", HttpMethod.POST, entity, Void.class); } catch
         * (HttpClientErrorException e) { if (e.getStatusCode() == HttpStatus.CONFLICT) { log.info("Repository {} (parent {}) already exists, reusing it...", repoName, projectKey);
         * return; } log.error("Could not create Bitbucket repo {} with projectKey key {}", repoName, projectKey, e); throw new
    ...
    public final class LocalGitRepositoryUrl extends VcsRepositoryUrl {
        ...
        public LocalGitRepositoryUrl(String projectKey, String repositorySlug) {
            final var urlString = serverBaseRoute + buildRepositoryPath(projectKey, repositorySlug);
            try {
        ...
        private String buildRepositoryPath(String projectKey, String repositorySlug) {
            return "/" + projectKey + "/" + repositorySlug + ".git";
        }
    }
}
