...
public class ExamResource {
     ...
     * Real Exams: StudentExam needs to be generated by an instructor (typically done beforehand)
     * Test Exam: StudentExam can be self-created by the user
     * Note: The Access control is performed in the {@link ExamAccessService#getOrCreateStudentExam(Long, Long)} to limit the DB-calls
     *
     * @param courseId the id of the course
     * @param examId   the id of the exam
    ...
    public ResponseEntity<StudentExam> getStudentExamForStart(@PathVariable Long courseId, @PathVariable Long examId) {
        ...
        StudentExam exam = examAccessService.getOrCreateStudentExam(courseId, examId);
        return ResponseEntity.ok(exam);
    }
