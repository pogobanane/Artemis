...
@SpringAware
public class CombineAllCommitsOfRepositoryIntoOneCallable implements Callable<Void>, java.io.Serializable {

    private transient GitService gitService;

    private final VcsRepositoryUrl repoUrl;

    public CombineAllCommitsOfRepositoryIntoOneCallable(VcsRepositoryUrl repoUrl) {
        this.repoUrl = repoUrl;
    }

    @Override
    public Void call() throws GitAPIException {
        gitService.combineAllCommitsOfRepositoryIntoOne(repoUrl);
        return null;
    }
